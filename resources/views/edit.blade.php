        ...
        <div class="bookForm">
            ...
            <div class="bookForm-form">
                ...
                <form action="{{route('updateBook', $book->id)}}" method="POST">
                    @csrf
                    <div class="input">
                        <input type="text" class="form-control @error('bookTitle') is-invalid @enderror" id="bookTitle" name="bookTitle" placeholder="Book Title" value="{{$book->bookTitle}}">
                    ...
                    <div class="input">
                        <input type="text" class="form-control @error('author') is-invalid @enderror" id="author" name="author" placeholder="Book Author" value="{{$book->author}}">
                    ...
                    <div class="input">
                        <input type="number" class="form-control @error('pageCount') is-invalid @enderror" id="pageCount" name="pageCount" placeholder="Book's Page Count" value="{{$book->pageCount}}">
                    ...
                    <div class="input">
                        <input type="number" class="form-control @error('releaseYear') is-invalid @enderror" id="releaseYear" name="releaseYear" placeholder="Book's Release Year" value="{{$book->releaseYear}}">
